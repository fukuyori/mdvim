...
### v0.5.5
- 🔧 File save behavior now follows Vim conventions
- ✨ Drag&drop and PWA file association now keep file handle (overwrite save)
- ✨ Ctrl+S to save, Ctrl+A for Save As dialog
- ✨ :w filename for Save As (updates file handle)
- ✨ :wq overwrites, :x saves only if modified
- ✨ PWA: :q/:wq/:x closes app
- 🗑️ Removed :saveas command (use :w filename instead)

### v0.5.4
- ⚡ Performance improvement for large files (1000+ lines)
- ⚡ Virtual scroll for line numbers
- ⚡ Optimized debounce processing

### v0.5.3
- ✨ Only yank operations copy to clipboard (delete does not)
- ✨ "*y to yank to clipboard, "*p to paste from clipboard

### v0.5.2
- 🐛 Fixed setRegister infinite recursion bug
- ✨ Auto-copy to clipboard on yank/delete

### v0.5.1
- 🔧 Applied new features to English and split versions
- 📝 Updated all documentation

### v0.5
- ✨ Named registers ("a-"z)
- ✨ Marks (ma, `a, 'a) with persistence
- ✨ Macro auto-save/load
- New commands: :reg, :marks, :macros, :delmarks, :delmacro

### v0.4.2
- 🐛 Fixed Service Worker chrome-extension error
- 🐛 Updated deprecated meta tags
...
### v0.3.6
- 🐛 Fixed preview display area issue when font size is increased

### v0.3.5
- 🐛 Fixed cursor position after D command (delete to end of line)
- 🐛 Fixed syntax error in split version

### v0.3.3
- 🚀 Performance: Removed editor heading highlight overlay

### v0.3.2
- 🐛 Fixed view mode button highlight state on startup

### v0.3.1
- ✨ Horizontal scroll follows cursor on long lines
